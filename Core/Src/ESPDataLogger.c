 ...
 *      Modified by Kenneth Dela Cuadra to work for floats
 */
...
void ESP_Send_Data (char *APIkey, int Field_num, float value)
{
	...
	sprintf (local_buf, "GET /update?api_key=%s&field%d=%f\r\n", APIkey, Field_num, value);
